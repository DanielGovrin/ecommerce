...
export const Card: React.FC<Item> = ({ id, mainTitle, secondaryTitle, image, price }) => {
   ...
   return (
      <div className={styles.cardContainer} data-testid={`${id} card`}>
         ...
         <div>
            <p
               className={addToCartClicked && !size ? styles.errorMessage : styles.notVisible}
               data-testid="choose size">
